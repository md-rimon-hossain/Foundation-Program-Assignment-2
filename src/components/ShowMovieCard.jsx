...
function ShowMovieCard({ movie, handleOpenModal }) {
  const imageUrl = movie?.image?.medium;
    ...
    <div className="group relative flex flex-col bg-[#262626] rounded-2xl overflow-hidden shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_20px_40px_-15px_rgba(229,9,20,0.4)] border border-white/5">
      ...
      <div className="relative flex flex-col grow p-5 -mt-10 z-10">
        ...
        <div className="mt-auto">
          <button onClick={()=> handleOpenModal(movie) } className="w-full flex items-center justify-center gap-2 bg-white/5 hover:bg-[#E50914] text-white py-2.5 rounded-xl font-semibold transition-all duration-300 border border-white/10 hover:border-transparent hover:shadow-[0_0_20px_-5px_rgba(229,9,20,0.6)]">
